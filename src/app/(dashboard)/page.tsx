...
export default function DashboardPage() {
  ...
  // Use CSS to show/hide mobile vs desktop layouts to prevent component remounting
  // which would cause useAIPMSession to re-initialize on resize
  return (
    <>
      {/* Mobile layout - hidden on md+ screens */}
      <div className="block md:hidden h-full -m-6">
        <MobileDashboard />
      </div>

      {/* Desktop layout - hidden on mobile, shown on md+ screens */}
      <div className="hidden md:flex h-full -m-6">
